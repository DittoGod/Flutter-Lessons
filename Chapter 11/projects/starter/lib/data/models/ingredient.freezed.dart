...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? id,  int? recipeId,  String? name,  double? amount,  double? weight)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Ingredient() when $default != null:
return $default(_that.id,_that.recipeId,_that.name,_that.amount,_that.weight);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? id,  int? recipeId,  String? name,  double? amount,  double? weight)  $default,) {final _that = this;
switch (_that) {
case _Ingredient():
return $default(_that.id,_that.recipeId,_that.name,_that.amount,_that.weight);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? id,  int? recipeId,  String? name,  double? amount,  double? weight)?  $default,) {final _that = this;
switch (_that) {
case _Ingredient() when $default != null:
return $default(_that.id,_that.recipeId,_that.name,_that.amount,_that.weight);case _:
  return null;
